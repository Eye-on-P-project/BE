...
public enum ErrorCode {
    ...
    ORGANIZATION_NAME_REQUIRED(HttpStatus.BAD_REQUEST, "ORGANIZATION_NAME_REQUIRED", "조직 이름은 필수입니다."),
    BUSINESS_NAME_REQUIRED(HttpStatus.BAD_REQUEST, "BUSINESS_NAME_REQUIRED", "상호명은 필수입니다."),
    BUSINESSMAN_NUM_REQUIRED(HttpStatus.BAD_REQUEST, "BUSINESSMAN_NUM_REQUIRED", "사업자등록번호는 필수입니다."),
    ESTABLISHED_AT_REQUIRED(HttpStatus.BAD_REQUEST, "ESTABLISHED_AT_REQUIRED", "개업일자는 필수입니다."),
    REPRESENTATIVE_NAME_REQUIRED(HttpStatus.BAD_REQUEST, "REPRESENTATIVE_NAME_REQUIRED", "대표자 이름은 필수입니다."),
    CORPORATE_NUM_REQUIRED(HttpStatus.BAD_REQUEST, "CORPORATE_NUM_REQUIRED", "법인등록번호는 필수입니다."),
    ...
    ORGANIZATION_SIGNUP_ALREADY_EXISTS(HttpStatus.CONFLICT, "ORGANIZATION_SIGNUP_ALREADY_EXISTS", "이미 동일 법인등록번호로 처리 중인 조직 신청이 있습니다."),
    ORGANIZATION_SIGNUP_PENDING(HttpStatus.FORBIDDEN, "ORGANIZATION_SIGNUP_PENDING", "조직 신청이 아직 승인되지 않았습니다."),
    ORGANIZATION_SIGNUP_REJECTED(HttpStatus.FORBIDDEN, "ORGANIZATION_SIGNUP_REJECTED", "조직 신청이 거절되었습니다."),
    ...
    SYSTEM_ADMIN_REQUIRED(HttpStatus.FORBIDDEN, "SYSTEM_ADMIN_REQUIRED", "시스템 관리자만 접근할 수 있습니다."),
    ...
    AGENT_SUBSCRIPTION_REQUIRED(HttpStatus.FORBIDDEN, "AGENT_SUBSCRIPTION_REQUIRED", "AI 동승자 기능은 구독 사용자만 사용할 수 있습니다."),
